...
class DilatedResBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, d_rate=[1, 1]):
        ...
        self.conv2 = nn.Conv2d(planes, planes, kernel_size=3, stride=stride, padding=d_rate[1], dilation=d_rate[1],
                               bias=False)
...
class FCN_SR(nn.Module):
    def __init__(self, in_channels=3, num_classes=1, pretrained=True):
        ...
        self.SR = nn.Sequential(conv1x1(512 + 64, 64), nn.BatchNorm2d(64), nn.ReLU(), DilatedResBlock(64, 64),
                                DeformConv2d(64, 64, modulation=True), nn.BatchNorm2d(64), nn.ReLU())
        self.classifier = nn.Conv2d(64, num_classes, kernel_size=1)

        self.classifier_aux = nn.Sequential(conv1x1(512, 64), nn.BatchNorm2d(64), nn.ReLU(), conv1x1(64, num_classes))
        # 这里有问题，不确定这样对不对
        initialize_weights(self.low, self.SR, self.classifier, self.classifier_aux)  #
